...
const dynamicArticles: PatientArticle[] = [
  ...
  <div class="consent-section">
    ...
    },
    {
      ...
      <h1 class="document-title">ИНФОРМИРОВАННОЕ ДОБРОВОЛЬНОЕ СОГЛАСИЕ ПАЦИЕНТА<br>НА ВЫПОЛНЕНИЕ ЭНДОСКОПИЧЕСКОГО ИССЛЕДОВАНИЯ / ВМЕШАТЕЛЬСТВА</h1>
      <h2 class="procedure-name">ДИАГНОСТИЧЕСКАЯ ЭЗОФАГОГАСТРОДУОДЕНОСКОПИЯ (ЭГДС)</h2>
      ...
      <div class="section">
        <h3>О ПРОЦЕДУРЕ</h3>
        <p>Рекомендованное Вам эндоскопическое исследование позволяет врачу осмотреть внутреннюю поверхность пищевода, желудка и двенадцатиперстной кишки и выявить заболевания этих органов. В зависимости от показаний, оно производится в неотложном или плановом порядке.</p>
        
        <p>ЭГДС выполняется при помощи гибкого эндоскопа, который проводится в пищевод через рот; он не препятствует дыханию и не вызывает боли.</p>
        
        <div class="procedure-details">
          <h4>Дополнительные методы во время ЭГДС:</h4>
          <ul>
            <li>Биопсия (взятие образцов ткани на анализ)</li>
          </ul>
          
          <div class="important-info">
            <p><strong>Средняя продолжительность исследования:</strong> 5-15 минут</p>
            <p>Видеоматериалы и другие данные, полученные во время исследования, принадлежат лечебному учреждению и могут быть использованы для научных и образовательных целей.</p>
          </div>
        </div>
      </div>
      ...
      <div class="section preparation-section">
        <h3>ПОДГОТОВКА К ИССЛЕДОВАНИЮ</h3>
        <p>ЭГДС проводится натощак, поэтому не следует есть, пить и курить, по меньшей мере, в течение 8 часов до исследования.</p>
        
        <div class="preparation-steps">
          <div class="step">
            <h4>Приём лекарств:</h4>
            <p>Если Вы постоянно принимаете лекарственные средства, согласуйте режим и условия их приёма с врачом-эндоскопистом.</p>
          </div>
        </div>
        ...
        <div class="arrival-info">
          ...
          <ul>
            <li>Паспортом</li>
            <li>Медицинской документацией</li>
            <li>Чистым полотенцем (или одноразовой впитывающей пелёнкой)</li>
          </ul>
        </div>
      </div>
      ...
      <div class="section complications-section">
        <h3>ВОЗМОЖНЫЕ ОСЛОЖНЕНИЯ</h3>
        <p class="warning-note">Предстоящее Вам эндоскопическое исследование является инвазивным инструментальным вмешательством и, несмотря на низкий уровень побочных эффектов (не более 0,1%) и максимально бережное выполнение, всё же несёт в себе риск возникновения следующих осложнений:</p>
        
        <ol class="complications-list">
          <li>Повреждение зубов</li>
          <li>Повреждение органа</li>
          <li>Кровотечение</li>
          <li>Затруднение дыхания, пневмония</li>
          <li>Сердечно-сосудистое расстройство</li>
          <li>Местные и аллергические реакции</li>
          <li>Обострение хронического заболевания</li>
        </ol>
      ...
      <div class="section after-procedure">
        <h3>ПОСЛЕ ОКОНЧАНИЯ ИССЛЕДОВАНИЯ</h3>
        <ul>
          <li>В течение 30 минут Вам не следует ничего есть и пить</li>
          <li>Если выполнялась биопсия, употребляйте охлаждённую пищу и напитки в течение суток</li>
          <li>Не рекомендуется водить машину, управлять какими-либо механизмами или принимать важные решения в течение 1 часа</li>
        </ul>
      ...
      <div class="section alternatives-section">
        <h3>АЛЬТЕРНАТИВА ЭГДС</h3>
        <p>Эндоскопическое исследование является одним из самых достоверных методов диагностики. Однако, в силу объективных причин, его выполнение в полном объёме и постановка точного диагноза возможны не во всех случаях.</p>
        
        <div class="alternatives-list">
          <p><strong>Возможной альтернативой ЭГДС являются лучевые методы исследования:</strong></p>
          <ul>
            <li>Рентгеноскопия пищевода, желудка, 12-пёрстной кишки</li>
            <li>Компьютерная томография пищевода, желудка, 12-пёрстной кишки</li>
          </ul>
        </div>
      </div>
      ...
      <div class="consent-section">
        <h3>ДЕКЛАРАЦИЯ ПАЦИЕНТА</h3>
        <div class="consent-text">
          <p>ДАЮ СОГЛАСИЕ НА ПРОВЕДЕНИЕ ЭГДС И ДОПОЛНИТЕЛЬНЫХ ИССЛЕДОВАНИЙ. Содержание настоящего документа мною прочитано и полностью мне понятно.</p>
    ...
    {
        id: 'rrs-consent',
        title: 'Согласие на ректороманоскопию',
        ...
        <div class="consent-document">
          ...
          <h1 class="document-title">ИНФОРМИРОВАННОЕ ДОБРОВОЛЬНОЕ СОГЛАСИЕ ПАЦИЕНТА<br>НА ВЫПОЛНЕНИЕ ЭНДОСКОПИЧЕСКОГО ИССЛЕДОВАНИЯ / ВМЕШАТЕЛЬСТВА</h1>
          <h2 class="procedure-name">ДИАГНОСТИЧЕСКАЯ И ЛЕЧЕБНАЯ РЕКТОРОМАНОСКОПИЯ (RRS)</h2>
          ...
          <div class="section">
            <h3>О ПРОЦЕДУРЕ</h3>
            <p>Рекомендованное Вам эндоскопическое исследование позволяет врачу осмотреть внутреннюю поверхность прямой и частично сигмовидной кишки.</p>
            
            <p>Ректороманоскопия выполняется при помощи ректоскопа, который проводится в прямую кишку через задний проход. Проведение ректоскопа, как правило, не вызывает сильной боли, однако возможен дискомфорт в заднем проходе и ощущение вздутия живота.</p>
            
            <div class="procedure-details">
              <h4>Дополнительные методы во время RRS:</h4>
              <ul>
                <li>Биопсия (взятие образцов ткани на анализ)</li>
                <li>Полипэктомия небольших полипов</li>
              </ul>
              ...
              <div class="important-info">
                <p><strong>Средняя продолжительность исследования:</strong> 5-10 минут</p>
                <p>Данные, полученные во время исследования, принадлежат лечебному учреждению и могут быть использованы для научных и образовательных целей.</p>
              </div>
            </div>
          </div>
          ...
          <div class="section preparation-section">
            ...
            <div class="arrival-info">
              <h4>В день исследования:</h4>
              <p>Просим Вас прибыть в проктологический кабинет в назначенное время с:</p>
              <ul>
                <li>Паспортом</li>
                <li>Медицинской документацией</li>
                <li>Чистой простыней</li>
          ...
          <div class="section complications-section">
            <h3>ВОЗМОЖНЫЕ ОСЛОЖНЕНИЯ</h3>
            <p class="warning-note">Предстоящее Вам проктологическое исследование является инвазивным инструментальным вмешательством и, несмотря на низкий уровень побочных эффектов (не более 0,1%) и максимально бережное выполнение, всё же несёт в себе риск возникновения следующих осложнений:</p>
          ...
          <div class="section alternatives-section">
            <h3>АЛЬТЕРНАТИВА RRS</h3>
            <p>Ректоскопическое исследование является одним из самых достоверных методов диагностики. Однако, в силу объективных причин, его выполнение в полном объёме и постановка точного диагноза возможны не во всех случаях.</p>
            
            <div class="alternatives-list">
              <p><strong>Возможной альтернативой RRS являются лучевые методы исследования:</strong></p>
              <ul>
                <li>Ирригоскопия</li>
                <li>Компьютерная томография толстого кишечника</li>
              </ul>
          ...
          <div class="consent-section">
            <h3>ДЕКЛАРАЦИЯ ПАЦИЕНТА</h3>
            <div class="consent-text">
              <p>ДАЮ СОГЛАСИЕ НА ПРОВЕДЕНИЕ RRS И ДОПОЛНИТЕЛЬНЫХ ИССЛЕДОВАНИЙ. Содержание настоящего документа мною прочитано и полностью мне понятно.</p>
